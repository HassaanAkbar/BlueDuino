...
using BlueDuino.Controls;
using BlueDuino.Views;
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    Symbol = Symbol.Link,
                    Label = "Connection",
                    DestinationPage = typeof(Views.ConnectionPage)
                },
                new NavMenuItem()
                {
                    Symbol = (Symbol)0xE707,
                    Label = "Joystick",
                    DestinationPage = typeof(Views.JoystickPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Message,
                    Label = "Terminal",
                    DestinationPage = typeof(Views.TerminalPage)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.MailReply,
                    Label = "Send us feedback",
                    DestinationPage = typeof(FeedbackPage),
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Help,
                    Label = "Help",
                    DestinationPage = typeof(HelpPage),
                }
            });
